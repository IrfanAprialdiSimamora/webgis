...
<html lang="en">
  <head>
    ...
    <style>
        ...
        #mapid {
            ...
            position: absolute;
            bottom: 0;
            z-index: -6; /* agar peta di bawah navbar */
        }
        .jumbotron{
            height: 100%;
            border-radius: 0;
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item ">
        <a href="login.php"><i class="fas fa-sign-in-alt mr-3" data-toggle="tooltip" title="Log In"></i>Login</a>
      </li>
      </h5>
    </div>
    </ul>
...
<div class=conten>
<a class="btn btn-primary btn-block" href="lokasi.php">Temukan Lokasi Anda</a>
</div>
<div id="mapid"></div>
